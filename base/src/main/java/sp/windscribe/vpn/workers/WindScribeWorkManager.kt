...
class WindScribeWorkManager(
    ...
    companion object {
        ...
        const val NOTIFICATION_HOURLY_WORKER_KEY = "sp.windscribe.vpn.notification_hourly_worker"
        const val NOTIFICATION_DAY_WORKER_KEY = "sp.windscribe.vpn.notification_day_worker"
        const val SESSION_WORKER_KEY = "sp.windscribe.vpn.session_worker"
        const val SESSION_HOURLY_WORKER_KEY = "sp.windscribe.vpn.session_hourly_worker"
        const val SESSION_DAY_WORKER_KEY = "sp.windscribe.vpn.session_day_worker"
        const val SERVER_LIST_WORKER_KEY = "sp.windscribe.vpn.server_list"
        const val STATIC_IP_WORKER_KEY = "sp.windscribe.vpn.static_ip"
        const val CREDENTIALS_WORKER_KEY = "sp.windscribe.vpn.credentials"
        const val PENDING_GOGGLE_RECEIPT_WORKER_KEY = "sp.windscribe.vpn.pendingGoogleReceipts"
        const val PENDING_AMAZON_RECEIPT_WORKER_KEY = "sp.windscribe.vpn.pendingAmazonReceipts"
        const val LATENCY_WORKER_KEY = "sp.windscribe.vpn.latencyWorker"
    }
}
