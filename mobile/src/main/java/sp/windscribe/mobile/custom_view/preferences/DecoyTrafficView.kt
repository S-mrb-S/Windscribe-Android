...
class DecoyTrafficView(private val childView: View) : BaseView(childView),
    AdapterView.OnItemSelectedListener {
    private val potentialTrafficVolume =
        childView.findViewById<TextView>(R.id.tv_current_potential_traffic)
    ...
    fun setAdapter(savedSelection: String, selections: Array<String>) {
        val selectionAdapter: ArrayAdapter<String> = ArrayAdapter<String>(
            childView.context, R.layout.drop_down_layout,
