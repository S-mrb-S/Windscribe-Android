...
import static sp.windscribe.mobile.email.AddEmailActivity.goToHomeAfterFinish;
import static sp.windscribe.vpn.Windscribe.appContext;
import static sp.windscribe.vpn.constants.ExtraConstants.PROMO_EXTRA;
...
import sp.windscribe.vpn.billing.BillingFragmentCallback;
import sp.windscribe.vpn.billing.GoogleBillingManager;
import sp.windscribe.vpn.billing.PurchaseState;
import sp.windscribe.vpn.billing.WindscribeInAppProduct;
