...
import static sp.windscribe.vpn.constants.ApiConstants.PAY_ID;
import static sp.windscribe.vpn.constants.ApiConstants.PROMO_CODE;
import static sp.windscribe.vpn.constants.BillingConstants.AMAZON_PURCHASED_ITEM;
import static sp.windscribe.vpn.constants.BillingConstants.AMAZON_PURCHASE_TYPE;
import static sp.windscribe.vpn.constants.BillingConstants.AMAZON_USER_ID;
import static sp.windscribe.vpn.constants.BillingConstants.GP_PACKAGE_NAME;
import static sp.windscribe.vpn.constants.BillingConstants.GP_PRODUCT_ID;
import static sp.windscribe.vpn.constants.BillingConstants.PLAY_STORE_UPDATE;
import static sp.windscribe.vpn.constants.BillingConstants.PURCHASED_ITEM;
import static sp.windscribe.vpn.constants.BillingConstants.PURCHASED_ITEM_NULL;
import static sp.windscribe.vpn.constants.BillingConstants.PURCHASE_TOKEN;
import static sp.windscribe.vpn.constants.BillingConstants.PURCHASE_TYPE;
...
import sp.windscribe.vpn.api.CreateHashMap;
...
import sp.windscribe.vpn.billing.AmazonProducts;
import sp.windscribe.vpn.billing.AmazonPurchase;
import sp.windscribe.vpn.billing.GoogleProducts;
import sp.windscribe.vpn.billing.PurchaseState;
import sp.windscribe.vpn.commonutils.RegionLocator;
...
import sp.windscribe.vpn.exceptions.UnknownException;
